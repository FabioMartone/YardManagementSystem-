...
public class ApplicationTests3 {
   ...
   @Test
    public void userNotInDatabase() throws URISyntaxException, InterruptedException, JsonMappingException, JsonProcessingException 
    {
        ...
        map.put("type", "out");
        map.put("timestamp_reg","2021-07-18 22:53:47");
